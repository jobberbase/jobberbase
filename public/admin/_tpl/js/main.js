			...
			editor: {
				...
				init: function(full) {
					...
					tinyMCE.init({
						...
						theme_advanced_buttons1 : full ? "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,styleselect,formatselect" : "bold,italic,underline,strikethrough,|,bulllist,numlist,|,outdent,indent,|,link,unlink,image,",
						...
						theme_advanced_statusbar_location : full ? "bottom" : "none",
