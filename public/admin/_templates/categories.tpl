{include file="header.tpl"}
		<div id="content">
				...
				{foreach from=$categories item=category}
					<div class="categoryItem" rel="{$category.id}">
						...
						<div class="categoryWrapper">
							<a href="#" title="Delete" class="deleteCategory"><img src="{$BASE_URL}_templates/default/img/icon-delete.png" alt="Edit" /> Delete</a>
							<label><span>Name:</span><input type="text" size="60" name="name[{$category.id}]" value="{$category.name}" /></label>
							<a href="#" title="Save" class="saveCategory"><img src="{$BASE_URL}_templates/default/img/disk.png" alt="Save" /> Save</a>
				...
				<p></p>
				<p>
					<a href="#" title="Add new category"><img src="{$BASE_URL}_templates/default/img/add.png" alt="Add new category" /> Add new category</a></p>
		</div><!-- #content -->
