{include file="header.tpl"}
		<div id="content">
				...
				{foreach from=$categories item=category}
					<div class="categoryItem" rel="{$category.id}">
						...
						<div class="categoryWrapper">
							<a href="#" title="Delete this category" class="deleteCategory"><img src="{$BASE_URL_ADMIN}_tpl/img/bin.png" alt="Delete" /></a>
							<label><span>Name:</span><input type="text" size="60" name="name[{$category.id}]" value="{$category.name}" /></label>
							<a href="#" title="Save changes" class="saveCategory"><img src="{$BASE_URL_ADMIN}_tpl/img/disk.png" alt="Save" /></a>
				...
				<p></p>
				<p>
					<a href="#" title="Add new category"><img src="{$BASE_URL_ADMIN}_tpl/img/plus-button.png" alt="Add new category" /></a>
		</div><!-- #content -->
