			...
			<form id="publish_form" method="post" action="{$BASE_URL}post/">
					...
					<table border="0" cellspacing="2" cellpadding="2">
						<tr>
							<td colspan="2">
								...
								<label for="type_id_{$types[tmp2].id}"><img src="{$BASE_URL}_tpl/{$THEME}/img/icon-{$types[tmp2].var_name}.png" alt="{$types[tmp2].name}" /></label>
								{/section}&nbsp;&nbsp;
						...
						<tr>
							<td class="publish-label" valign="top">{$translations.publish.location_label}:</td>
							<td>
						...
						<tr>
							<td class="publish-label" valign="top">{$translations.publish.description_label}:</td>
				...
				<fieldset>
					...
					<table border="0" cellspacing="2" cellpadding="2">
						...
						<tr>
							<td class="publish-label" valign="top">{$translations.publish.website_label}:</td>
