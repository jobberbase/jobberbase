...
ALTER TABLE `pages` ADD COLUMN `accepts_files` enum('0','1') NOT NULL AFTER `has_form`;
 ...
 UPDATE `settings_categories` SET `name` = 'Spam / Security Settings' WHERE `name` = 'Spam Settings';
 ...
 UPDATE `settings` SET `ordering` = 8 WHERE `name` = 'report_post_after';
 UPDATE `settings` SET `ordering` = 9 WHERE `name` = 'post_notify_on';
 UPDATE `settings` SET `name` = 'enable_captcha_on_post_page' WHERE `name` = 'captcha_enable_on_post_page';
 UPDATE `settings` SET `name` = 'enable_captcha_on_apply_page' WHERE `name` = 'captcha_enable_on_apply_page';
 UPDATE `settings` SET `name` = 'enable_captcha_on_contact_page' WHERE `name` = 'captcha_enable_on_contact_page';
...
UPDATE `links`, (SELECT MAX(`id`) as `id` FROM `links` WHERE `url`='primary') AS `x` SET `menu` = `x`.`id` WHERE `menu` = 'primary';
UPDATE `links`, (SELECT MAX(`id`) as `id` FROM `links` WHERE `url`='secondary') AS `x` SET `menu` = `x`.`id` WHERE `menu` = 'secondary';
UPDATE `links`, (SELECT MAX(`id`) as `id` FROM `links` WHERE `url`='footer') AS `x` SET `menu` = `x`.`id` WHERE `menu` = 'footer';
UPDATE `links`, (SELECT MAX(`id`) as `id` FROM `links` WHERE `url`='___footer1___') AS `x` SET `menu` = `x`.`id` WHERE `menu` = 'footer1';
UPDATE `links`, (SELECT MAX(`id`) as `id` FROM `links` WHERE `url`='___footer2___') AS `x` SET `menu` = `x`.`id` WHERE `menu` = 'footer2';
UPDATE `links`, (SELECT MAX(`id`) as `id` FROM `links` WHERE `url`='___footer3___') AS `x` SET `menu` = `x`.`id` WHERE `menu` = 'footer3';
