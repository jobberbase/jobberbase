...
(51, 1, 'keep_uploaded_cvs', 'Keep uploaded CV''s', 'Keep the CV''s that applicants upload. If on, the CV''s can be downloaded from admin area. Otherwise they will be deleted right after sending application emails.', 'boolean', 'radiobutton', 'no|yes', NULL, '0', 10);
